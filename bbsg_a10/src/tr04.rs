...
pub async fn tr04(para: Query<Param>) -> WebTemp {
    ...
    assv.sort_by(|b, a| {
        a.v[VarType::ChgStnSellTr.tousz()]
            .v
            .partial_cmp(&b.v[VarType::ChgStnSellTr.tousz()].v)
            .unwrap()
    });
    norv.sort_by(|b, a| {
        a.v[VarType::ChgStnSellTr.tousz()]
